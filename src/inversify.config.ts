...
import { RabbitTxClient } from "./rabbit/RabbitTxClient";
...
container.bind<RabbitTxClient>(TYPES.RabbitTxClient).to(RabbitTxClient).inSingletonScope();
container.bind<PostgreSQL>(TYPES.PostgreSQL).to(PostgreSQL).inSingletonScope();
container.bind<PostgresClientForRepositories>(TYPES.PostgresClientForRepositories).to(PostgresClientForRepositories).inSingletonScope();
